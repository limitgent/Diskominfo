        ...
        <div class="col-lg-6">
          <div class="meeting-item">
            ...
            <div class="down-content">
              ...
              <a href="<?php echo base_url('user/C_user/tampil_karyawan/' . $div->id_divisi); ?>">
                <h4> Divisi <?= $div->nama_divisi ?></h4>
              </a>
...
<script src="<?php echo base_url(); ?>assets/user/js/lightbox.js"></script>
<script src="<?php echo base_url(); ?>assets/user/js/tabs.js"></script>
<script src="<?php echo base_url(); ?>assets/user/js/video.js"></script>
<script src="<?php echo base_url(); ?>assets/user/js/slick-slider.js"></script>
